  ...
  if (!trendingContent) {
    return (
      <div className="h-screen text-white relative">
        <Navbar />
        <div className="absolute top-0 w-full left-0 bg-black flex justify-center items-center h-full -z-20 shimmer">
        </div>
      </div>)
  }
  return (
    <>
      <div className="relative h-screen text-white">
        <Navbar />
        {imgLoading && (
          <div className="absolute top-0 left-0 h-full w-full bg-black flex justify-center items-center  shimmer -z-10"/>
          
        )}
        <img src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path} alt="hero bg"
