                    ...
                    <div className="flex-1">
                        <div className="relative">
                            <img
                                ...
                                className="mt-4"
                            />
                            <div className="flex  max-[500px]:h-[63.2px] max-[500px]:w-[264px] items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-xl px-2">
                                <img
